...
{
    public abstract class NotificationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NotificationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NotificationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NotificationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NotificationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NotificationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NotificationDbContext, Task<T>> func)
        {
            T result;
